...
function associateMeal(username, id){
  mealdb.exist(id).then(
    function(res){
      ...
      } else console.log("WARNING the meal you are trying to associate doesn't exist in the collection.");
    },
    function(err){
      console.log("promises error in the mongo user: " + err);
    }
  )
}
/*
// Given the id of a meal, lookForMeal returns true if
