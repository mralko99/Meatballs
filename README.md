...
* In-depth view of the chatbot working scheme can be found here: [Chatbot Scheme](../mralko99/Meatballs/master/documents/chatbot architecture.pdf)
* The architecture of the project can be found here: [Project Architecture](mralko99/Meatballs/master/documents/MeatBALLS Architecture (1).pdf)
* [Project Architecture](../documents/MeatBALLS Architecture (1).pdf)
