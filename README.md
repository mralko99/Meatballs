...
* In-depth view of the chatbot working scheme can be found here: [Chatbot Scheme](../Meatballs/master/documents/chatbot architecture.pdf)
* The architecture of the project can be found here: [Project Architecture](../master/documents/MeatBALLS Architecture (1).pdf)
* [Project Architecture](../Meatballs/documents/MeatBALLS Architecture (1).pdf)
